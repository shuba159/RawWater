...
<link href="${ctxStatic}/bootstrap/bootstrap-select.min.css" type="text/css" rel="stylesheet" />
<script src="${ctxStatic}/bootstrap/3.3.4/js/bootstrap.min.js"  type="text/javascript"></script>
<script src="${ctxStatic}/bootstrap/bootstrap-select.min.js"  type="text/javascript"></script>
